...
class UpdateGoalOfTheMonthNotesPostService {
    ...
    static func executeRequest (_ params:[String: Any], completionHandler: @escaping (SuccessModel) -> Void) {
        ...
        let request = manager.request( URL + "fitness_center/update_notes", method: .post, parameters: params, encoding: URLEncoding.default, headers: header).responseJSON { response in
